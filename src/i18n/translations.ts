...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    hero: {
      ...
      description: "Guiding you to realign with your true nature through clarity, presence, and the wisdom of transformation",
  ...
  fr: {
    ...
    hero: {
      ...
      description: "Je vous guide pour vous réaligner avec votre vraie nature à travers la clarté, la présence et la sagesse de la transformation",
